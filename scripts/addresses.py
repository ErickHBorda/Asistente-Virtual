...
addresses = {
    'googlemaps': {
        ...
        'url': 'https://www.google.com.pe/maps',
        'buscador': 'https://www.google.com.pe/maps/search/' # Acceso al buscador de cada página
    },
    'google': {
        'sitios': ['Google', 'el buscador', 'navegador'],
        'url': 'https://www.google.com.pe/',
        'buscador': 'https://www.google.com.pe/search?q='
    },
    'youtube': {
        'sitios': ['Youtube'],
    ...
    'spotify': {
        ...
        'buscador': 'https://open.spotify.com/search/ '#AGREGAMOS ESTA URL PARA QUE ABRA SPOTIFY
    },
    'steam': {
        'sitios': ['Steam', 'Stim'],
    ...
    'mercadolibre': {
        ...
        'buscador': 'https://listado.mercadolibre.com.pe/'
    },
    'linkedin': {
        'sitios': ['LinKedIn'],
    ...
    'sourcecode': {
        ...
        'url': 'https://github.com/ErickHBorda/Asistente-Virtual.git',
    },
    'plazofijo': {
